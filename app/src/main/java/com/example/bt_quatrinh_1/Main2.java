...
public class Main2 extends AppCompatActivity implements OnSeekBarChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        panels[0] = (View) findViewById(R.id.o1);
        panels[1] = (View) findViewById(R.id.o2);
        panels[2] = (View) findViewById(R.id.o3);
        panels[3] = (View) findViewById(R.id.o4);
        panels[4] = (View) findViewById(R.id.o5);
        skcontrol = (SeekBar)findViewById(R.id.seekbar);
