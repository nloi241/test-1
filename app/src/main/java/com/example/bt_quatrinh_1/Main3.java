...
public class Main3 extends AppCompatActivity implements OnSeekBarChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        panels[0] = (View) findViewById(R.id.view);
        panels[1] = (View) findViewById(R.id.view2);
        panels[2] = (View) findViewById(R.id.view3);
        panels[3] = (View) findViewById(R.id.view4);
        panels[4] = (View) findViewById(R.id.view5);
        skcontrol = (SeekBar)findViewById(R.id.seekbar2);
